...
use App\Mail\SendEmailApproversRevised;

use App\Models\CARFormProcessor;

class SendEmailApproversRevisedJobs implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(): void
    {
        ...
        Mail::to($form->approvedBy->email)->cc($form->emailCc->pluck('email')->toArray())->send(new SendEmailApproversRevised($details));
    }
}
